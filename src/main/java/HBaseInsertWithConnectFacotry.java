...
public class HBaseInsertWithConnectFacotry {
	...
	private static final String USAGE = "HBase write directly with connection factory performace test.\n"
					+ " Usage:  <arg1> <arg2> <arg3> <arg4> <arg5> [<arg6>...].\n"
					+ " Or quit(Ctrl-C) then input : java -cp HBaseTest.jar HBaseInsertWithConnectFacotry <arg1> <arg2> <arg3> <arg4> <arg5> [<arg6>...].\n"
